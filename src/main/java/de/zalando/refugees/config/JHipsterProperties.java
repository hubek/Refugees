...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "refugees@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "refugees API";

        private String description = "refugees API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "refugees";
