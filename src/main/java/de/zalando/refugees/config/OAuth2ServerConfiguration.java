...
import de.zalando.refugees.security.AjaxLogoutSuccessHandler;
import de.zalando.refugees.security.AuthoritiesConstants;
import de.zalando.refugees.security.Http401UnauthorizedEntryPoint;
    ...
    protected static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
        ...
        public void configure(HttpSecurity http) throws Exception {
            ...
            .and()
                ...
                .antMatchers("/api/appUsers/**").permitAll()
